  ...
  return (
    <div className="items-center justify-center">
      <form className="max-w-sm mx-auto">
        <div className="mb-5">
          <label for="textInput" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Text Input: </label>
        ...
        <div className="mb-5">
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">File Input: </label>
